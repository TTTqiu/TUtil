...
public class TUtil {
     ...
     */
    public static void loadImage(Context context, String address, ImageView imageView,
                                 int maxMemorySpace, int maxDiskSpace) {
        if (mImageLoader==null){
            mImageLoader=new ImageLoader();
        }
        mImageLoader.loadImage(context,address,imageView,maxMemorySpace,maxDiskSpace);
    }
